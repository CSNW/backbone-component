...
(function (global, factory) {
  ...
  var handlebars__default = 'default' in handlebars ? handlebars['default'] : handlebars;
  ...
  handlebars__default.registerHelper('placeholder', placeholder);
  handlebars__default.registerHelper('outlet', outlet);
  handlebars__default.registerHelper('render', render);
  handlebars__default.registerHelper('get', get);
  handlebars__default.registerHelper('bound', bound$1);
  handlebars__default.registerHelper('oneway', oneway$1);
  handlebars__default.registerHelper('computed', computed$1);
  handlebars__default.registerHelper('eq', eq);
  handlebars__default.registerHelper('not', not);
  handlebars__default.registerHelper('array', array);
  handlebars__default.registerHelper('object', object);
  ...
  var Component = View.extend(
    ...
    },
    {
      registerAs: function(name) {
        var Type = this;
        handlebars__default.registerHelper(name, function(id, view, options) {
          if (!view) {
            options = id;
            view =
          ...
          var data =
            options.fn && options.data ? handlebars__default.createFrame(options.data) : {};
          ...
          return handlebars__default.helpers.placeholder(id);
